...
module COBALT_reg_diag
  ...
  subroutine cobalt_reg_diagnostics(diag_list,axes,init_time,phyto,zoo,bact,cobalt)
    ...
    !
    phyto(DIAZO)%id_P_C_max = register_diag_field(package_name, "P_C_max_Di", axes(1:3), &
         init_time, "Diaz. Maximum Growth Rate", "sec-1", missing_value = missing_value1)

    phyto(LARGE)%id_P_C_max = register_diag_field(package_name, "P_C_max_Lg", axes(1:3), &
         init_time, "Large Phyto. Maximum Growth Rate", "sec-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_P_C_max = register_diag_field(package_name, "P_C_max_Md", axes(1:3), &
         init_time, "Medium Phyto. Maximum Growth Rate", "sec-1", missing_value = missing_value1)

    phyto(SMALL)%id_P_C_max = register_diag_field(package_name, "P_C_max_Sm", axes(1:3), &
         init_time, "Small Phyto. Maximum Growth Rate", "sec-1", missing_value = missing_value1)

    phyto(DIAZO)%id_alpha = register_diag_field(package_name, "alpha_Di", axes(1:3), &
         init_time, "Diaz. Photo. vs Irrad. slope", "gC gChl-1 sec-1 (W m-2)-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_alpha = register_diag_field(package_name, "alpha_Lg", axes(1:3), &
         init_time, "Large Phyto. Photo. vs Irrad. slope", "gC gChl-1 sec-1 (W m-2)-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_alpha = register_diag_field(package_name, "alpha_Md", axes(1:3), &
         init_time, "Medium Phyto. Photo. vs Irrad. slope", "gC gChl-1 sec-1 (W m-2)-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_alpha = register_diag_field(package_name, "alpha_Sm", axes(1:3), &
         init_time, "Small Phyto. Photo. vs Irrad. slope", "gC gChl-1 sec-1 (W m-2)-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_bresp = register_diag_field(package_name, "bresp_Di", axes(1:3), &
         init_time, "Diaz. Basal Respiration Rate", "sec-1", missing_value = missing_value1)

    phyto(LARGE)%id_bresp = register_diag_field(package_name, "bresp_Lg", axes(1:3), &
         init_time, "Large Phyto. Basal Respiration Rate", "sec-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_bresp = register_diag_field(package_name, "bresp_Md", axes(1:3), &
         init_time, "Medium Phyto. Basal Respiration Rate", "sec-1", missing_value = missing_value1)

    phyto(SMALL)%id_bresp = register_diag_field(package_name, "bresp_Sm", axes(1:3), &
         init_time, "Small Phyto. Basal Respiration Rate", "sec-1", missing_value = missing_value1)

    phyto(DIAZO)%id_def_fe = register_diag_field(package_name, "def_fe_Di", axes(1:3), &
         init_time, "Diaz. Phyto. Fe Deficiency", "dimensionless", missing_value = missing_value1)

    phyto(LARGE)%id_def_fe = register_diag_field(package_name, "def_fe_Lg", axes(1:3), &
         init_time, "Large Phyto. Fe Deficiency", "dimensionless", missing_value = missing_value1)

    phyto(MEDIUM)%id_def_fe = register_diag_field(package_name, "def_fe_Md", axes(1:3), &
         init_time, "Medium Phyto. Fe Deficiency", "dimensionless", missing_value = missing_value1)

    phyto(SMALL)%id_def_fe = register_diag_field(package_name, "def_fe_Sm", axes(1:3), &
         init_time, "Small Phyto. Fe Deficiency", "dimensionless", missing_value = missing_value1)

    phyto(DIAZO)%id_felim = register_diag_field(package_name, "felim_Di", axes(1:3), &
         init_time, "Diaz. Phyto. Fed uptake Limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_felim = register_diag_field(package_name, "felim_Lg", axes(1:3), &
         init_time, "Large Phyto. Fed uptake Limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_felim = register_diag_field(package_name, "felim_Md", axes(1:3), &
         init_time, "Medium Phyto. Fed uptake Limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_felim = register_diag_field(package_name, "felim_Sm", axes(1:3), &
         init_time, "Small Phyto. Fed uptake Limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_irrlim = register_diag_field(package_name, "irrlim_Di", axes(1:3), &
         init_time, "Diaz. Phyto. Light Limitation", "dimensionless", missing_value = missing_value1)

    phyto(LARGE)%id_irrlim = register_diag_field(package_name, "irrlim_Lg", axes(1:3), &
         init_time, "Large Phyto. Light Limitation", "dimensionless", missing_value = missing_value1)

    phyto(MEDIUM)%id_irrlim = register_diag_field(package_name, "irrlim_Md", axes(1:3), &
         init_time, "Medium Phyto. Light Limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_irrlim = register_diag_field(package_name, "irrlim_Sm", axes(1:3), &
         init_time, "Small Phyto. Light Limitation", "dimensionless", missing_value = missing_value1)

    phyto(DIAZO)%id_theta = register_diag_field(package_name, "theta_Di", axes(1:3), &
         init_time, "Diaz. Phyto. Chl:C", "g Chl (g C)-1", missing_value = missing_value1)

    phyto(LARGE)%id_theta = register_diag_field(package_name, "theta_Lg", axes(1:3), &
         init_time, "Large Phyto. Chl:C", "g Chl (g C)-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_theta = register_diag_field(package_name, "theta_Md", axes(1:3), &
         init_time, "Medium Phyto. Chl:C", "g Chl (g C)-1", missing_value = missing_value1)

    phyto(SMALL)%id_theta = register_diag_field(package_name, "theta_Sm", axes(1:3), &
         init_time, "Small Phyto. Chl:C", "g Chl (g C)-1", missing_value = missing_value1)

    phyto(DIAZO)%id_chl = register_diag_field(package_name, "chl_Di", axes(1:3), &
         init_time, "Diaz. Phyto. Chlorophyll", "ug Kg-1", missing_value = missing_value1)

    phyto(LARGE)%id_chl = register_diag_field(package_name, "chl_Lg", axes(1:3), &
         init_time, "Large Phyto. Chlorophyll", "ug Kg-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_chl = register_diag_field(package_name, "chl_Md", axes(1:3), &
         init_time, "Medium Phyto. Chlorophyll", "ug Kg-1", missing_value = missing_value1)

    phyto(SMALL)%id_chl = register_diag_field(package_name, "chl_Sm", axes(1:3), &
         init_time, "Small Phyto. Chlorophyll", "ug Kg-1", missing_value = missing_value1)

    phyto(DIAZO)%id_mu = register_diag_field(package_name, "mu_Di", axes(1:3), &
         init_time, "Diaz. Phyto. Overall Growth Rate", "s-1", missing_value = missing_value1)

    phyto(LARGE)%id_mu = register_diag_field(package_name, "mu_Lg", axes(1:3), &
         init_time, "Large Phyto. Overall Growth Rate", "s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_mu = register_diag_field(package_name, "mu_Md", axes(1:3), &
         init_time, "Medium Phyto. Overall Growth Rate", "s-1", missing_value = missing_value1)

    phyto(SMALL)%id_mu = register_diag_field(package_name, "mu_Sm", axes(1:3), &
         init_time, "Small Phyto. Growth Rate", "s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_f_mu_mem = register_diag_field(package_name, "mu_mem_Di", axes(1:3), &
         init_time, "Diaz. Phyto. Growth Memory", "s-1", missing_value = missing_value1)

    phyto(LARGE)%id_f_mu_mem = register_diag_field(package_name, "mu_mem_Lg", axes(1:3), &
         init_time, "Large Phyto. Growth memory", "s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_f_mu_mem = register_diag_field(package_name, "mu_mem_Md", axes(1:3), &
         init_time, "Medium Phyto. Growth memory", "s-1", missing_value = missing_value1)

    phyto(SMALL)%id_f_mu_mem = register_diag_field(package_name, "mu_mem_Sm", axes(1:3), &
         init_time, "Small Phyto. Growth Memory", "s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_f_pcmlim_aclm = register_diag_field(package_name, "pcmlim_aclm_Di", axes(1:3), &
         init_time, "Diaz. Phyto. acclimation nut*temp lim", "none", missing_value = missing_value1)

    phyto(LARGE)%id_f_pcmlim_aclm = register_diag_field(package_name, "pcmlim_aclm_Lg", axes(1:3), &
         init_time, "Large Phyto. acclimation nut*temp lim", "none", missing_value = missing_value1)

    phyto(MEDIUM)%id_f_pcmlim_aclm = register_diag_field(package_name, "pcmlim_aclm_Md", &
         axes(1:3), &
         init_time, "Medium Phyto. acclimation nut*temp lim", "none", missing_value = missing_value1)

    phyto(SMALL)%id_f_pcmlim_aclm = register_diag_field(package_name, "pcmlim_aclm_Sm", axes(1:3), &
         init_time, "Small Phyto. acclimation nut*temp lim", "none", missing_value = missing_value1)

    phyto(DIAZO)%id_pcmlim_aclm_inst = register_diag_field(package_name, "pcmlim_aclm_inst_Di", &
         axes(1:3), &
         init_time, "Diaz. Phyto. instantaneous nut*temp lim", "none", &
         missing_value = missing_value1)

    phyto(LARGE)%id_pcmlim_aclm_inst = register_diag_field(package_name, "pcmlim_aclm_inst_Lg", &
         axes(1:3), &
         init_time, "Large Phyto. instantaneous nut*temp lim", "none", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_pcmlim_aclm_inst = register_diag_field(package_name, "pcmlim_aclm_inst_Md", &
         axes(1:3), &
         init_time, "Medium Phyto. instantaneous nut*temp lim", "none", &
         missing_value = missing_value1)

    phyto(SMALL)%id_pcmlim_aclm_inst = register_diag_field(package_name, "pcmlim_aclm_inst_Sm", &
         axes(1:3), &
         init_time, "Small Phyto. instantaneous nut*temp lim", "none", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_vmove = register_diag_field(package_name, "vmove_Di", axes(1:3), &
         init_time, "Diaz. Phyto. movement", "m s-1", missing_value = missing_value1)

    phyto(LARGE)%id_vmove = register_diag_field(package_name, "vmove_Lg", axes(1:3), &
         init_time, "Large Phyto. movement", "m s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_vmove = register_diag_field(package_name, "vmove_Md", axes(1:3), &
         init_time, "Medium Phyto. movement", "m s-1", missing_value = missing_value1)

    phyto(SMALL)%id_vmove = register_diag_field(package_name, "vmove_Sm", axes(1:3), &
         init_time, "Small Phyto. movement", "m s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_mu_mix = register_diag_field(package_name, "mu_mix_Di", axes(1:3), &
         init_time, "Diaz. Phyto. ML ave", "s-1", missing_value = missing_value1)

    phyto(LARGE)%id_mu_mix = register_diag_field(package_name, "mu_mix_Lg", axes(1:3), &
         init_time, "Large Phyto. ML ave", "s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_mu_mix = register_diag_field(package_name, "mu_mix_Md", axes(1:3), &
         init_time, "Medium Phyto. ML ave", "s-1", missing_value = missing_value1)

    phyto(SMALL)%id_mu_mix = register_diag_field(package_name, "mu_mix_Sm", axes(1:3), &
         init_time, "Small Phyto. ML ave", "s-1", missing_value = missing_value1)

    phyto(LARGE)%id_nh4lim = register_diag_field(package_name, "nh4lim_Lg", axes(1:3), &
         init_time, "Ammonia Limitation of Large Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_nh4lim = register_diag_field(package_name, "nh4lim_Md", axes(1:3), &
         init_time, "Ammonia Limitation of Medium Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_nh4lim = register_diag_field(package_name, "nh4lim_Sm", axes(1:3), &
         init_time, "Ammonia Limitation of Small Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_nh4lim = register_diag_field(package_name, "nh4lim_Di", axes(1:3), &
         init_time, "Ammonia Limitation of Diazo", "dimensionless", missing_value = missing_value1)

    phyto(LARGE)%id_no3lim = register_diag_field(package_name, "no3lim_Lg", axes(1:3), &
         init_time, "Nitrate Limitation of Large Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_no3lim = register_diag_field(package_name, "no3lim_Md", axes(1:3), &
         init_time, "Nitrate Limitation of Medium Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_no3lim = register_diag_field(package_name, "no3lim_Sm", axes(1:3), &
         init_time, "Nitrate Limitation of Small Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_no3lim = register_diag_field(package_name, "no3lim_Di", axes(1:3), &
         init_time, "Ammonia Limitation of Diazo", "dimensionless", missing_value = missing_value1)

    phyto(DIAZO)%id_po4lim = register_diag_field(package_name, "po4lim_Di", axes(1:3), &
         init_time, "Phosphate Limitation of Diaz. Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_po4lim = register_diag_field(package_name, "po4lim_Lg", axes(1:3), &
         init_time, "Phosphate Limitation of Large Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_po4lim = register_diag_field(package_name, "po4lim_Md", axes(1:3), &
         init_time, "Phosphate Limitation of Medium Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_po4lim = register_diag_field(package_name, "po4lim_Sm", axes(1:3), &
         init_time, "Phosphate Limitation of Small Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_liebig_lim = register_diag_field(package_name, "liebig_Sm", axes(1:3), &
         init_time, "Overall (Liebig) nutrient lim., Small Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_liebig_lim = register_diag_field(package_name, "liebig_Md", axes(1:3), &
         init_time, "Overall (Liebig) nutrient lim., Medium Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_liebig_lim = register_diag_field(package_name, "liebig_Lg", axes(1:3), &
         init_time, "Overall (Liebig) nutrient lim., Large Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_liebig_lim = register_diag_field(package_name, "liebig_Di", axes(1:3), &
         init_time, "Overall (Liebig) nutrient lim., Diazotrophs", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_o2lim = register_diag_field(package_name, "o2lim_Di", axes(1:3), &
         init_time, "Oxygen Limitation of Diaz. Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_q_fe_2_n = register_diag_field(package_name, "q_fe_2_n_Di", axes(1:3), &
         init_time, "Fe:N ratio of Diaz. Phyto", "mol Fe/mol N", missing_value = missing_value1)

    phyto(LARGE)%id_q_fe_2_n = register_diag_field(package_name, "q_fe_2_n_Lg", axes(1:3), &
         init_time, "Fe:N ratio of Large Phyto", "mol Fe/mol N", missing_value = missing_value1)

    phyto(MEDIUM)%id_q_fe_2_n = register_diag_field(package_name, "q_fe_2_n_Md", axes(1:3), &
         init_time, "Fe:N ratio of Medium Phyto", "mol Fe/mol N", missing_value = missing_value1)

    phyto(SMALL)%id_q_fe_2_n = register_diag_field(package_name, "q_fe_2_n_Sm", axes(1:3), &
         init_time, "Fe:N ratio of Small Phyto", "mol Fe/mol N", missing_value = missing_value1)

    phyto(DIAZO)%id_q_p_2_n = register_diag_field(package_name, "q_p_2_n_Di", axes(1:3), &
         init_time, "P:N ratio of Diaz. Phyto", "mol P/mol N", missing_value = missing_value1)

    phyto(LARGE)%id_q_p_2_n = register_diag_field(package_name, "q_p_2_n_Lg", axes(1:3), &
         init_time, "P:N ratio of Large Phyto", "mol P/mol N", missing_value = missing_value1)

    phyto(MEDIUM)%id_q_p_2_n = register_diag_field(package_name, "q_p_2_n_Md", axes(1:3), &
         init_time, "P:N ratio of Medium Phyto", "mol P/mol N", missing_value = missing_value1)

    phyto(SMALL)%id_q_p_2_n = register_diag_field(package_name, "q_p_2_n_Sm", axes(1:3), &
         init_time, "P:N ratio of Small Phyto", "mol P/mol N", missing_value = missing_value1)

    phyto(LARGE)%id_silim = register_diag_field(package_name, "silim_Lg", axes(1:3), &
         init_time, "SiO4 Limitation of Large Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_silim = register_diag_field(package_name, "silim_Md", axes(1:3), &
         init_time, "SiO4 Limitation of Medium Phyto", "dimensionless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_q_si_2_n = register_diag_field(package_name, "q_si_2_n_Lg", axes(1:3), &
         init_time, "Si:N ratio of Large Phyto", "mol Si/mol N", missing_value = missing_value1)

    phyto(MEDIUM)%id_q_si_2_n = register_diag_field(package_name, "q_si_2_n_Md", axes(1:3), &
    ...
    phyto(DIAZO)%id_jzloss_n = register_diag_field(package_name, "jzloss_n_Di", axes(1:3), &
         init_time, "Diazotroph nitrogen loss to zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jzloss_n = register_diag_field(package_name, "jzloss_n_Lg", axes(1:3), &
         init_time, "Large phyto nitrogen loss to zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jzloss_n = register_diag_field(package_name, "jzloss_n_Md", axes(1:3), &
         init_time, "Medium phyto nitrogen loss to zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jzloss_n = register_diag_field(package_name, "jzloss_n_Sm", axes(1:3), &
         init_time, "Small phyto nitrogen loss to zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jzloss_p = register_diag_field(package_name, "jzloss_p_Di", axes(1:3), &
         init_time, "Diazotroph phosphorus loss to zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jzloss_p = register_diag_field(package_name, "jzloss_p_Lg", axes(1:3), &
         init_time, "Large phyto phosphorus loss to zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jzloss_p = register_diag_field(package_name, "jzloss_p_Md", axes(1:3), &
         init_time, "Medium phyto phosphorus loss to zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jzloss_p = register_diag_field(package_name, "jzloss_p_Sm", axes(1:3), &
         init_time, "Small phyto phosphorus loss to zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jzloss_fe = register_diag_field(package_name, "jzloss_fe_Di", axes(1:3), &
         init_time, "Diazotroph iron loss to zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jzloss_fe = register_diag_field(package_name, "jzloss_fe_Lg", axes(1:3), &
         init_time, "Large phyto iron loss to zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jzloss_fe = register_diag_field(package_name, "jzloss_fe_Md", axes(1:3), &
         init_time, "Medium phyto iron loss to zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jzloss_fe = register_diag_field(package_name, "jzloss_fe_Sm", axes(1:3), &
         init_time, "Small phyto iron loss to zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jzloss_sio2 = register_diag_field(package_name, "jzloss_sio2_Di", axes(1:3), &
         init_time, "Diazotroph silica loss to zooplankton", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jzloss_sio2 = register_diag_field(package_name, "jzloss_sio2_Lg", axes(1:3), &
         init_time, "Large phyto silica loss to zooplankton", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jzloss_sio2 = register_diag_field(package_name, "jzloss_sio2_Md", axes(1:3), &
         init_time, "Medium phyto silica loss to zooplankton", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jzloss_sio2 = register_diag_field(package_name, "jzloss_sio2_Sm", axes(1:3), &
    ...
    phyto(DIAZO)%id_jaggloss_n = register_diag_field(package_name, "jaggloss_n_Di", axes(1:3), &
         init_time, "Diazotroph nitrogen loss to aggregation", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jaggloss_n = register_diag_field(package_name, "jaggloss_n_Lg", axes(1:3), &
         init_time, "Large phyto nitrogen loss to aggregation", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jaggloss_n = register_diag_field(package_name, "jaggloss_n_Md", axes(1:3), &
         init_time, "Medium phyto nitrogen loss to aggregation", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jaggloss_n = register_diag_field(package_name, "jaggloss_n_Sm", axes(1:3), &
         init_time, "Small phyto nitrogen loss to aggregation", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jaggloss_p = register_diag_field(package_name, "jaggloss_p_Di", axes(1:3), &
         init_time, "Diazotroph phosphorus loss to aggregation", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jaggloss_p = register_diag_field(package_name, "jaggloss_p_Lg", axes(1:3), &
         init_time, "Large phyto phosphorus loss to aggregation", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jaggloss_p = register_diag_field(package_name, "jaggloss_p_Md", axes(1:3), &
         init_time, "Medium phyto phosphorus loss to aggregation", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jaggloss_p = register_diag_field(package_name, "jaggloss_p_Sm", axes(1:3), &
         init_time, "Small phyto phosphorus loss to aggregation", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jaggloss_fe = register_diag_field(package_name, "jaggloss_fe_Di", axes(1:3), &
         init_time, "Diazotroph iron loss to aggregation", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jaggloss_fe = register_diag_field(package_name, "jaggloss_fe_Lg", axes(1:3), &
         init_time, "Large phyto iron loss to aggregation", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jaggloss_fe = register_diag_field(package_name, "jaggloss_fe_Md", axes(1:3), &
         init_time, "Medium phyto iron loss to aggregation", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jaggloss_fe = register_diag_field(package_name, "jaggloss_fe_Sm", axes(1:3), &
         init_time, "Small phyto iron loss to aggregation", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jaggloss_sio2 = register_diag_field(package_name, "jaggloss_sio2_Di", &
         axes(1:3), &
         init_time, "Diazotroph silica loss to aggregation", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jaggloss_sio2 = register_diag_field(package_name, "jaggloss_sio2_Lg", &
         axes(1:3), &
         init_time, "Large phyto silica loss to aggregation", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jaggloss_sio2 = register_diag_field(package_name, "jaggloss_sio2_Md", &
         axes(1:3), &
         init_time, "Medium phyto silica loss to aggregation", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jaggloss_sio2 = register_diag_field(package_name, "jaggloss_sio2_Sm", &
         axes(1:3), &
         init_time, "Small phyto silica loss to aggregation", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_stress_fac = register_diag_field(package_name, "stress_fac_Di", axes(1:3), &
         init_time, "Diazotroph stress factor", "dimensionless", missing_value = missing_value1)

    phyto(LARGE)%id_stress_fac = register_diag_field(package_name, "stress_fac_Lg", axes(1:3), &
         init_time, "Large phyto stress factor", "dimensionless", missing_value = missing_value1)

    phyto(MEDIUM)%id_stress_fac = register_diag_field(package_name, "stress_fac_Md", axes(1:3), &
         init_time, "Medium phyto stress factor", "dimensionless", missing_value = missing_value1)

    phyto(SMALL)%id_stress_fac = register_diag_field(package_name, "stress_fac_Sm", axes(1:3), &
    ...
    !
    phyto(DIAZO)%id_jvirloss_n = register_diag_field(package_name, "jvirloss_n_Di", axes(1:3), &
         init_time, "Diazotroph nitrogen loss to viruses", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jvirloss_n = register_diag_field(package_name, "jvirloss_n_Lg", axes(1:3), &
         init_time, "Large phyto nitrogen loss to viruses", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jvirloss_n = register_diag_field(package_name, "jvirloss_n_Md", axes(1:3), &
         init_time, "Medium phyto nitrogen loss to viruses", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jvirloss_n = register_diag_field(package_name, "jvirloss_n_Sm", axes(1:3), &
         init_time, "Small phyto nitrogen loss to viruses", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jvirloss_p = register_diag_field(package_name, "jvirloss_p_Di", axes(1:3), &
         init_time, "Diazotroph phosphorus loss to viruses", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jvirloss_p = register_diag_field(package_name, "jvirloss_p_Lg", axes(1:3), &
         init_time, "Large phyto phosphorus loss to viruses", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jvirloss_p = register_diag_field(package_name, "jvirloss_p_Md", axes(1:3), &
         init_time, "Medium phyto phosphorus loss to viruses", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jvirloss_p = register_diag_field(package_name, "jvirloss_p_Sm", axes(1:3), &
         init_time, "Small phyto phosphorus loss to viruses", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jvirloss_fe = register_diag_field(package_name, "jvirloss_fe_Di", axes(1:3), &
         init_time, "Diazotroph iron loss to viruses", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jvirloss_fe = register_diag_field(package_name, "jvirloss_fe_Lg", axes(1:3), &
         init_time, "Large phyto iron loss to viruses", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jvirloss_fe = register_diag_field(package_name, "jvirloss_fe_Md", axes(1:3), &
         init_time, "Medium phyto iron loss to viruses", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jvirloss_fe = register_diag_field(package_name, "jvirloss_fe_Sm", axes(1:3), &
         init_time, "Small phyto iron loss to viruses", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jvirloss_sio2 = register_diag_field(package_name, "jvirloss_sio2_Di", &
         axes(1:3), &
         init_time, "Diazotroph silica loss to viruses", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jvirloss_sio2 = register_diag_field(package_name, "jvirloss_sio2_Lg", &
         axes(1:3), &
         init_time, "Large phyto silica loss to viruses", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jvirloss_sio2 = register_diag_field(package_name, "jvirloss_sio2_Md", &
         axes(1:3), &
         init_time, "Medium phyto silica loss to viruses", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jvirloss_sio2 = register_diag_field(package_name, "jvirloss_sio2_Sm", &
         axes(1:3), &
    ...
    phyto(DIAZO)%id_jmortloss_n = register_diag_field(package_name, "jmortloss_n_Di", axes(1:3), &
         init_time, "Diazotroph nitrogen loss to mortality", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jmortloss_n = register_diag_field(package_name, "jmortloss_n_Lg", axes(1:3), &
         init_time, "Large phyto nitrogen loss to mortality", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jmortloss_n = register_diag_field(package_name, "jmortloss_n_Md", axes(1:3), &
         init_time, "Medium phyto nitrogen loss to mortality", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jmortloss_n = register_diag_field(package_name, "jmortloss_n_Sm", axes(1:3), &
         init_time, "Small phyto nitrogen loss to mortality", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jmortloss_p = register_diag_field(package_name, "jmortloss_p_Di", axes(1:3), &
         init_time, "Diazotroph phosphorus loss to mortality", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jmortloss_p = register_diag_field(package_name, "jmortloss_p_Lg", axes(1:3), &
         init_time, "Large phyto phosphorus loss to mortality", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jmortloss_p = register_diag_field(package_name, "jmortloss_p_Md", axes(1:3), &
         init_time, "Medium phyto phosphorus loss to mortality", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jmortloss_p = register_diag_field(package_name, "jmortloss_p_Sm", axes(1:3), &
         init_time, "Small phyto phosphorus loss to mortality", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jmortloss_fe = register_diag_field(package_name, "jmortloss_fe_Di", axes(1:3), &
         init_time, "Diazotroph iron loss to mortality", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jmortloss_fe = register_diag_field(package_name, "jmortloss_fe_Lg", axes(1:3), &
         init_time, "Large phyto iron loss to mortality", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jmortloss_fe = register_diag_field(package_name, "jmortloss_fe_Md", &
         axes(1:3), &
         init_time, "Medium phyto iron loss to mortality", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jmortloss_fe = register_diag_field(package_name, "jmortloss_fe_Sm", axes(1:3), &
    ...
    !
    phyto(DIAZO)%id_jdissloss_si = register_diag_field(package_name, "jdissloss_si_Di", axes(1:3), &
         init_time, "Diazotroph silica dissolution from respiration and mortality", &
         "mol Si kg-1 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_jdissloss_si = register_diag_field(package_name, "jdissloss_si_Lg", axes(1:3), &
         init_time, "Large phyto silica dissolution from respiration and mortality", &
         "mol Si kg-1 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_jdissloss_si = register_diag_field(package_name, "jdissloss_si_Md", &
         axes(1:3), &
         init_time, "Medium phyto silica dissolution from respiration and mortality", &
         "mol Si kg-1 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_jdissloss_si = register_diag_field(package_name, "jdissloss_si_Sm", axes(1:3), &
         init_time, "Small phyto silica dissolution from respiration and mortality", &
         "mol Si kg-1 s-1", missing_value = missing_value1)
    !
    ! Register diagnostics for phytoplankton exudation
    !
    phyto(DIAZO)%id_jexuloss_n = register_diag_field(package_name, "jexuloss_n_Di", axes(1:3), &
         init_time, "Diazotroph nitrogen loss via exudation", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jexuloss_n = register_diag_field(package_name, "jexuloss_n_Lg", axes(1:3), &
         init_time, "Large phyto nitrogen loss via exudation", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jexuloss_n = register_diag_field(package_name, "jexuloss_n_Md", axes(1:3), &
         init_time, "Medium phyto nitrogen loss via exudation", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jexuloss_n = register_diag_field(package_name, "jexuloss_n_Sm", axes(1:3), &
         init_time, "Small phyto nitrogen loss via exudation", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jexuloss_p = register_diag_field(package_name, "jexuloss_p_Di", axes(1:3), &
         init_time, "Diazotroph phosphorus loss via exudation", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jexuloss_p = register_diag_field(package_name, "jexuloss_p_Lg", axes(1:3), &
         init_time, "Large phyto phosphorus loss via exudation", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jexuloss_p = register_diag_field(package_name, "jexuloss_p_Md", axes(1:3), &
         init_time, "Medium phyto phosphorus loss via exudation", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jexuloss_p = register_diag_field(package_name, "jexuloss_p_Sm", axes(1:3), &
         init_time, "Small phyto phosphorus loss via exudation", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jexuloss_fe = register_diag_field(package_name, "jexuloss_fe_Di", axes(1:3), &
         init_time, "Diazotroph iron loss via exudation", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jexuloss_fe = register_diag_field(package_name, "jexuloss_fe_Lg", axes(1:3), &
         init_time, "Large phyto iron loss via exudation", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jexuloss_fe = register_diag_field(package_name, "jexuloss_fe_Md", axes(1:3), &
         init_time, "Medium phyto iron loss via exudation", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jexuloss_fe = register_diag_field(package_name, "jexuloss_fe_Sm", axes(1:3), &
    ...
    !
    phyto(DIAZO)%id_jhploss_n = register_diag_field(package_name, "jhploss_n_Di", axes(1:3), &
         init_time, "Diazotroph nitrogen loss to higher predators", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jhploss_n = register_diag_field(package_name, "jhploss_n_Lg", axes(1:3), &
         init_time, "Large phyto nitrogen loss to higher predators", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jhploss_n = register_diag_field(package_name, "jhploss_n_Md", axes(1:3), &
         init_time, "Medium phyto nitrogen loss to higher predators", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jhploss_n = register_diag_field(package_name, "jhploss_n_Sm", axes(1:3), &
         init_time, "Small phyto nitrogen loss to higher predators", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jhploss_p = register_diag_field(package_name, "jhploss_p_Di", axes(1:3), &
         init_time, "Diazotroph phosphorus loss to higher predators", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jhploss_p = register_diag_field(package_name, "jhploss_p_Lg", axes(1:3), &
         init_time, "Large phyto phosphorus loss to higher predators", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jhploss_p = register_diag_field(package_name, "jhploss_p_Md", axes(1:3), &
         init_time, "Medium phyto phosphorus loss to higher predators", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jhploss_p = register_diag_field(package_name, "jhploss_p_Sm", axes(1:3), &
         init_time, "Small phyto phosphorus loss to higher predators", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jhploss_fe = register_diag_field(package_name, "jhploss_fe_Di", axes(1:3), &
         init_time, "Diazotroph iron loss to higher predators", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jhploss_fe = register_diag_field(package_name, "jhploss_fe_Lg", axes(1:3), &
         init_time, "Large phyto iron loss to higher predators", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jhploss_fe = register_diag_field(package_name, "jhploss_fe_Md", axes(1:3), &
         init_time, "Medium phyto iron loss to higher predators", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jhploss_fe = register_diag_field(package_name, "jhploss_fe_Sm", axes(1:3), &
         init_time, "Small phyto iron loss to higher predators", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jhploss_sio2 = register_diag_field(package_name, "jhploss_sio2_Di", axes(1:3), &
         init_time, "Diazotroph silica loss to higher predators", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jhploss_sio2 = register_diag_field(package_name, "jhploss_sio2_Lg", axes(1:3), &
         init_time, "Large phyto silica loss to higher predators", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jhploss_sio2 = register_diag_field(package_name, "jploss_sio2_Md", axes(1:3), &
         init_time, "Medium phyto silica loss to higher predators", "mol Si kg-1 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jhploss_sio2 = register_diag_field(package_name, "jhploss_sio2_Sm", axes(1:3), &
    ...
    phyto(DIAZO)%id_juptake_n2 = register_diag_field(package_name, "juptake_n2_Di", axes(1:3), &
         init_time, "Nitrogen fixation", "mol N kg-1 s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_juptake_fe = register_diag_field(package_name, "juptake_fe_Di", axes(1:3), &
         init_time, "Diaz. phyto. Fed uptake", "mol Fe kg-1 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_juptake_fe = register_diag_field(package_name, "juptake_fe_Lg", axes(1:3), &
         init_time, "Large phyto. Fed uptake", "mol Fe kg-1 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_juptake_fe = register_diag_field(package_name, "juptake_fe_Md", axes(1:3), &
         init_time, "Medium phyto. Fed uptake", "mol Fe kg-1 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_juptake_fe = register_diag_field(package_name, "juptake_fe_Sm", axes(1:3), &
         init_time, "Small phyto. Fed uptake", "mol Fe kg-1 s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_juptake_nh4 = register_diag_field(package_name, "juptake_nh4_Di", axes(1:3), &
         init_time, "Diaz. phyto. NH4 uptake", "mol NH4 kg-1 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_juptake_nh4 = register_diag_field(package_name, "juptake_nh4_Lg", axes(1:3), &
         init_time, "Large phyto. NH4 uptake", "mol NH4 kg-1 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_juptake_nh4 = register_diag_field(package_name, "juptake_nh4_Md", axes(1:3), &
         init_time, "Medium phyto. NH4 uptake", "mol NH4 kg-1 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_juptake_nh4 = register_diag_field(package_name, "juptake_nh4_Sm", axes(1:3), &
         init_time, "Small phyto. NH4 uptake", "mol NH4 kg-1 s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_juptake_no3 = register_diag_field(package_name, "juptake_no3_Di", axes(1:3), &
         init_time, "Diaz. phyto. NO3 uptake", "mol NO3 kg-1 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_juptake_no3 = register_diag_field(package_name, "juptake_no3_Lg", axes(1:3), &
         init_time, "Large phyto. NO3 uptake", "mol NO3 kg-1 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_juptake_no3 = register_diag_field(package_name, "juptake_no3_Md", axes(1:3), &
         init_time, "Medium phyto. NO3 uptake", "mol NO3 kg-1 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_juptake_no3 = register_diag_field(package_name, "juptake_no3_Sm", axes(1:3), &
         init_time, "Small phyto. NO3 uptake", "mol NO3 kg-1 s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_juptake_po4 = register_diag_field(package_name, "juptake_po4_Di", axes(1:3), &
         init_time, "Diaz. phyto. PO4 uptake", "mol PO4 kg-1 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_juptake_po4 = register_diag_field(package_name, "juptake_po4_Lg", axes(1:3), &
         init_time, "Large phyto. PO4 uptake", "mol PO4 kg-1 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_juptake_po4 = register_diag_field(package_name, "juptake_po4_Md", axes(1:3), &
         init_time, "Medium phyto. PO4 uptake", "mol PO4 kg-1 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_juptake_po4 = register_diag_field(package_name, "juptake_po4_Sm", axes(1:3), &
         init_time, "Small phyto. PO4 uptake", "mol PO4 kg-1 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_juptake_sio4 = register_diag_field(package_name, "juptake_sio4_Lg", axes(1:3), &
         init_time, "Large phyto. SiO4 uptake", "mol kg-1 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_juptake_sio4 = register_diag_field(package_name, "juptake_sio4_Md", &
         axes(1:3), &
         init_time, "Medium phyto. SiO4 uptake", "mol kg-1 s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_jprod_n = register_diag_field(package_name, "jprod_ndi", axes(1:3), &
         init_time, "Diazotroph Nitrogen production", "mol kg-1 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_jprod_n = register_diag_field(package_name, "jprod_nsmp", axes(1:3), &
         init_time, "Small phyto. Nitrogen production", "mol kg-1 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jprod_n = register_diag_field(package_name, "jprod_nmdp", axes(1:3), &
         init_time, "Medium phyto. Nitrogen production", "mol kg-1 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jprod_n = register_diag_field(package_name, "jprod_nlgp", axes(1:3), &
    ...
    zoo(1)%id_jzloss_n = register_diag_field(package_name, "jzloss_n_Smz", axes(1:3), &
         init_time, "Small zooplankton nitrogen loss to zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jzloss_n = register_diag_field(package_name, "jzloss_n_Mdz", axes(1:3), &
         init_time, "Medium-sized zooplankton nitrogen loss to zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jzloss_n = register_diag_field(package_name, "jzloss_n_Lgz", axes(1:3), &
         init_time, "Large zooplankton nitrogen loss to zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jzloss_p = register_diag_field(package_name, "jzloss_p_Smz", axes(1:3), &
         init_time, "Small zooplankton phosphorus loss to zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jzloss_p = register_diag_field(package_name, "jzloss_p_Mdz", axes(1:3), &
         init_time, "Medium-sized zooplankton phosphorus loss to zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jzloss_p = register_diag_field(package_name, "jzloss_p_Lgz", axes(1:3), &
    ...
    zoo(1)%id_jingest_n = register_diag_field(package_name, "jingest_n_Smz", axes(1:3), &
         init_time, "Ingestion of nitrogen by small zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jingest_n = register_diag_field(package_name, "jingest_n_Mdz", axes(1:3), &
         init_time, "Ingestion of nitrogen by medium-sized zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jingest_n = register_diag_field(package_name, "jingest_n_Lgz", axes(1:3), &
         init_time, "Ingestion of nitrogen by large zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jingest_p = register_diag_field(package_name, "jingest_p_Smz", axes(1:3), &
         init_time, "Ingestion of phosphorous by small zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jingest_p = register_diag_field(package_name, "jingest_p_Mdz", axes(1:3), &
         init_time, "Ingestion of phosphorous by medium-sized zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jingest_p = register_diag_field(package_name, "jingest_p_Lgz", axes(1:3), &
         init_time, "Ingestion of phosphorous by large zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jingest_sio2 = register_diag_field(package_name, "jingest_sio2_Smz", axes(1:3), &
         init_time, "Ingestion of sio2 by small zooplankton", "mol SiO2 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jingest_sio2 = register_diag_field(package_name, "jingest_sio2_Mdz", axes(1:3), &
         init_time, "Ingestion of sio2 by medium-sized zooplankton", "mol SiO2 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jingest_sio2 = register_diag_field(package_name, "jingest_sio2_Lgz", axes(1:3), &
         init_time, "Ingestion of sio2 by large zooplankton", "mol SiO2 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jingest_fe = register_diag_field(package_name, "jingest_fe_Smz", axes(1:3), &
         init_time, "Ingestion of Fe by small zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jingest_fe = register_diag_field(package_name, "jingest_fe_Mdz", axes(1:3), &
         init_time, "Ingestion of Fe by medium-sized zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jingest_fe = register_diag_field(package_name, "jingest_fe_Lgz", axes(1:3), &
    ...
    zoo(1)%id_jprod_ndet = register_diag_field(package_name, "jprod_ndet_Smz", axes(1:3), &
         init_time, "Production of nitrogen detritus by small zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_ndet = register_diag_field(package_name, "jprod_ndet_Mdz", axes(1:3), &
         init_time, "Production of nitrogen detritus by medium zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_ndet = register_diag_field(package_name, "jprod_ndet_Lgz", axes(1:3), &
         init_time, "Production of nitrogen detritus by large zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jprod_pdet = register_diag_field(package_name, "jprod_pdet_Smz", axes(1:3), &
         init_time, "Production of phosphorous detritus by small zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_pdet = register_diag_field(package_name, "jprod_pdet_Mdz", axes(1:3), &
         init_time, "Production of phosphorous detritus by medium zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_pdet = register_diag_field(package_name, "jprod_pdet_Lgz", axes(1:3), &
         init_time, "Production of phosphorous detritus by large zooplankton", "mol P kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jprod_sidet = register_diag_field(package_name, "jprod_sidet_Smz", axes(1:3), &
         init_time, "Production of opal detritus by small zooplankton", "mol SiO2 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_sidet = register_diag_field(package_name, "jprod_sidet_Mdz", axes(1:3), &
         init_time, "Production of opal detritus by medium zooplankton", "mol SiO2 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_sidet = register_diag_field(package_name, "jprod_sidet_Lgz", axes(1:3), &
         init_time, "Production of opal detritus by large zooplankton", "mol SiO2 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jprod_sio4 = register_diag_field(package_name, "jprod_sio4_Smz", axes(1:3), &
         init_time, "Production of sio4 through grazing/dissolution", "mol SiO4 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_sio4 = register_diag_field(package_name, "jprod_sio4_Mdz", axes(1:3), &
         init_time, "Production of sio4 through grazing/dissolution", "mol SiO4 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_sio4 = register_diag_field(package_name, "jprod_sio4_Lgz", axes(1:3), &
         init_time, "Production of sio4 through grazing/dissolution", "mol SiO4 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jprod_fedet = register_diag_field(package_name, "jprod_fedet_Smz", axes(1:3), &
         init_time, "Production of iron detritus by small zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_fedet = register_diag_field(package_name, "jprod_fedet_Mdz", axes(1:3), &
         init_time, "Production of iron detritus by medium zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_fedet = register_diag_field(package_name, "jprod_fedet_Lgz", axes(1:3), &
    ...
    zoo(1)%id_jprod_sldop = register_diag_field(package_name, "jprod_sldop_Smz", axes(1:3), &
         init_time, &
         "Production of semi-labile dissolved organic phosphorous by small zooplankton", &
         "mol P kg-1 s-1", missing_value = missing_value1)

    zoo(2)%id_jprod_sldop = register_diag_field(package_name, "jprod_sldop_Mdz", axes(1:3), &
         init_time, &
         "Production of semi-labile dissolved organic phosphorous by medium zooplankton", &
         "mol P kg-1 s-1", missing_value = missing_value1)

    zoo(3)%id_jprod_sldop = register_diag_field(package_name, "jprod_sldop_Lgz", axes(1:3), &
         init_time, &
         "Production of semi-labile dissolved organic phosphorous by large zooplankton", &
         "mol P kg-1 s-1", missing_value = missing_value1)

    ! dissolved iron
    zoo(1)%id_jprod_fed = register_diag_field(package_name, "jprod_fed_Smz", axes(1:3), &
         init_time, "Production of dissolved iron by small zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_fed = register_diag_field(package_name, "jprod_fed_Mdz", axes(1:3), &
         init_time, "Production of dissolved iron by medium-sized zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_fed = register_diag_field(package_name, "jprod_fed_Lgz", axes(1:3), &
         init_time, "Production of dissolved iron by large zooplankton", "mol Fe kg-1 s-1", &
         missing_value = missing_value1)

    ! phosphate
    zoo(1)%id_jprod_po4 = register_diag_field(package_name, "jprod_po4_Smz", axes(1:3), &
         init_time, "Production of phosphate by small zooplankton", "mol PO4 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_po4 = register_diag_field(package_name, "jprod_po4_Mdz", axes(1:3), &
         init_time, "Production of phosphate by medium-sized zooplankton", "mol PO4 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_po4 = register_diag_field(package_name, "jprod_po4_Lgz", axes(1:3), &
         init_time, "Production of phosphate by large zooplankton", "mol PO4 kg-1 s-1", &
         missing_value = missing_value1)

    ! ammonia
    zoo(1)%id_jprod_nh4 = register_diag_field(package_name, "jprod_nh4_Smz", axes(1:3), &
         init_time, "Production of ammonia by small zooplankton", "mol NH4 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_nh4 = register_diag_field(package_name, "jprod_nh4_Mdz", axes(1:3), &
         init_time, "Production of ammonia by medium-sized zooplankton", "mol NH4 kg-1 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_nh4 = register_diag_field(package_name, "jprod_nh4_Lgz", axes(1:3), &
    ...
    zoo(1)%id_jprod_n = register_diag_field(package_name, "jprod_nsmz", axes(1:3), &
         init_time, "Production of new biomass (nitrogen) by small zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_n = register_diag_field(package_name, "jprod_nmdz", axes(1:3), &
         init_time, "Production of new biomass (nitrogen) by medium-sized zooplankton", &
         "mol N kg-1 s-1", missing_value = missing_value1)

    zoo(3)%id_jprod_n = register_diag_field(package_name, "jprod_nlgz", axes(1:3), &
         init_time, "Production of new biomass (nitrogen) by large zooplankton", "mol N kg-1 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_o2lim = register_diag_field(package_name, "o2lim_Smz", axes(1:3), &
         init_time, "Oxygen limitation of small zooplankton", "dimensionless", &
         missing_value = missing_value1)

    zoo(2)%id_o2lim = register_diag_field(package_name, "o2lim_Mdz", axes(1:3), &
         init_time, "Oxygen limitation of medium-sized zooplankton", "dimensionless", &
         missing_value = missing_value1)

    zoo(3)%id_o2lim = register_diag_field(package_name, "o2lim_Lgz", axes(1:3), &
         init_time, "Oxygen limitation of large zooplankton", "dimensionless", &
         missing_value = missing_value1)

    zoo(1)%id_temp_lim = register_diag_field(package_name, "temp_lim_Smz", axes(1:3), &
         init_time, "Temperature limitation of small zooplankton", "dimensionless", &
         missing_value = missing_value1)

    zoo(2)%id_temp_lim = register_diag_field(package_name, "temp_lim_Mdz", axes(1:3), &
         init_time, "Temperature limitation of medium-sized zooplankton", "dimensionless", &
         missing_value = missing_value1)

    zoo(3)%id_temp_lim = register_diag_field(package_name, "temp_lim_Lgz", axes(1:3), &
...
! CAS added a "plus_btm" version of jprod_nh4 to use for the remoc CMIP variable
    ...
    phyto(DIAZO)%id_ffe_btm = register_diag_field(package_name, "ffedi_btm", axes(1:2), &
         init_time, "diazo Fe sinking flux to bottom", "mol m-2 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_ffe_btm = register_diag_field(package_name, "ffelg_btm", axes(1:2), &
         init_time, "large phyto Fe sinking flux to bottom", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_ffe_btm = register_diag_field(package_name, "ffemd_btm", axes(1:2), &
         init_time, "medium phyto Fe sinking flux to bottom", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_ffe_btm = register_diag_field(package_name, "ffesm_btm", axes(1:2), &
    ...
    phyto(DIAZO)%id_fn_btm = register_diag_field(package_name, "fndi_btm", axes(1:2), &
         init_time, "diazo N sinking flux to bottom", "mol m-2 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_fn_btm = register_diag_field(package_name, "fnlg_btm", axes(1:2), &
         init_time, "large phyto N sinking flux to bottom", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_fn_btm = register_diag_field(package_name, "fnmd_btm", axes(1:2), &
         init_time, "medium phyto N sinking flux to bottom", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_fn_btm = register_diag_field(package_name, "fnsm_btm", axes(1:2), &
    ...
    phyto(DIAZO)%id_fp_btm = register_diag_field(package_name, "fpdi_btm", axes(1:2), &
         init_time, "diazo P sinking flux to bottom", "mol m-2 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_fp_btm = register_diag_field(package_name, "fplg_btm", axes(1:2), &
         init_time, "large phyto P sinking flux to bottom", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_fp_btm = register_diag_field(package_name, "fpmd_btm", axes(1:2), &
         init_time, "medium phyto P sinking flux to bottom", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_fp_btm = register_diag_field(package_name, "fpsm_btm", axes(1:2), &
    ...
    phyto(LARGE)%id_fsi_btm = register_diag_field(package_name, "fsilg_btm", axes(1:2), &
         init_time, "large phyto Si sinking flux to bottom", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_fsi_btm = register_diag_field(package_name, "fsimd_btm", axes(1:2), &
 ...
 ! Diagnostics to assess averaging over the bottom mixed layer.
    ...
    phyto(SMALL)%id_sfc_f_n = register_diag_field(package_name, "sfc_nsmp", axes(1:2), &
         init_time, "Surface small phyto. nitrogen", "mol kg-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_f_n = register_diag_field(package_name, "sfc_nmdp", axes(1:2), &
         init_time, "Surface medium phyto. nitrogen", "mol kg-1", missing_value = missing_value1)

    phyto(LARGE)%id_sfc_f_n = register_diag_field(package_name, "sfc_nlgp", axes(1:2), &
         init_time, "Surface large phyto. nitrogen", "mol kg-1", missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_f_n = register_diag_field(package_name, "sfc_ndi", axes(1:2), &
         init_time, "Surface diazotroph nitrogen", "mol kg-1", missing_value = missing_value1)

    phyto(SMALL)%id_sfc_chl = register_diag_field(package_name, "sfc_chl_smp", axes(1:2), &
         init_time, "Surface small phyto. chlorophyll", "ug kg-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_chl = register_diag_field(package_name, "sfc_chl_mdp", axes(1:2), &
         init_time, "Surface medium phyto. chlorophyll", "ug kg-1", missing_value = missing_value1)

    phyto(LARGE)%id_sfc_chl = register_diag_field(package_name, "sfc_chl_lgp", axes(1:2), &
         init_time, "Surface large phyto. chlorophyll", "ug kg-1", missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_chl = register_diag_field(package_name, "sfc_chl_di", axes(1:2), &
         init_time, "Surface diazotroph chlorophyll", "mol kg-1", missing_value = missing_value1)

    phyto(SMALL)%id_sfc_def_fe = register_diag_field(package_name, "sfc_def_fe_smp", axes(1:2), &
         init_time, "Surface small phyto. iron deficiency", "dimensionsless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_def_fe = register_diag_field(package_name, "sfc_def_fe_mdp", axes(1:2), &
         init_time, "Surface medium phyto. iron deficiency", "dimensionsless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_sfc_def_fe = register_diag_field(package_name, "sfc_def_fe_lgp", axes(1:2), &
         init_time, "Surface large phyto. iron deficiency", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_def_fe = register_diag_field(package_name, "sfc_def_fe_di", axes(1:2), &
         init_time, "Surface diazotroph iron deficiency", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_sfc_felim = register_diag_field(package_name, "sfc_felim_smp", axes(1:2), &
         init_time, "Surface small phyto. iron uptake limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_felim = register_diag_field(package_name, "sfc_felim_mdp", axes(1:2), &
         init_time, "Surface medium phyto. iron uptake limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_sfc_felim = register_diag_field(package_name, "sfc_felim_lgp", axes(1:2), &
         init_time, "Surface large phyto. iron uptake limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_felim = register_diag_field(package_name, "sfc_felim_di", axes(1:2), &
         init_time, "Surface diazotroph iron uptake limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_q_fe_2_n = register_diag_field(package_name, "sfc_q_fe_2_n_di", axes(1:2), &
         init_time, "Surface diazotroph iron:nitrogen", "moles Fe (moles N)-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_sfc_q_fe_2_n = register_diag_field(package_name, "sfc_q_fe_2_n_smp", &
         axes(1:2), &
         init_time, "Surface small phyto. iron:nitrogen", "moles Fe (moles N)-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_q_fe_2_n = register_diag_field(package_name, "sfc_q_fe_2_n_mdp", &
         axes(1:2), &
         init_time, "Surface medium phyto. iron:nitrogen", "moles Fe (moles N)-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_sfc_q_fe_2_n = register_diag_field(package_name, "sfc_q_fe_2_n_lgp", &
         axes(1:2), &
         init_time, "Surface large phyto. iron:nitrogen", "moles Fe (moles N)-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_q_p_2_n = register_diag_field(package_name, "sfc_q_p_2_n_di", axes(1:2), &
         init_time, "Surface diazotroph P:N", "moles P (moles N)-1", missing_value = missing_value1)

    phyto(SMALL)%id_sfc_q_p_2_n = register_diag_field(package_name, "sfc_q_p_2_n_smp", axes(1:2), &
         init_time, "Surface small phyto. P:N", "moles P (moles N)-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_q_p_2_n = register_diag_field(package_name, "sfc_q_p_2_n_mdp", axes(1:2), &
         init_time, "Surface medium phyto. P:N", "moles P (moles N)-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_sfc_q_p_2_n = register_diag_field(package_name, "sfc_q_p_2_n_lgp", axes(1:2), &
         init_time, "Surface large phyto. P:N", "moles P (moles N)-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_sfc_irrlim = register_diag_field(package_name, "sfc_irrlim_smp", axes(1:2), &
         init_time, "Surface small phyto. light limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_irrlim = register_diag_field(package_name, "sfc_irrlim_mdp", axes(1:2), &
         init_time, "Surface medium phyto. light limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_sfc_irrlim = register_diag_field(package_name, "sfc_irrlim_lgp", axes(1:2), &
         init_time, "Surface large phyto. light limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_irrlim = register_diag_field(package_name, "sfc_irrlim_di", axes(1:2), &
         init_time, "Surface diazotroph light limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_sfc_theta = register_diag_field(package_name, "sfc_theta_smp", axes(1:2), &
         init_time, "Surface small phyto. Chl:C", "g Chl (g C)-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_theta = register_diag_field(package_name, "sfc_theta_mdp", axes(1:2), &
         init_time, "Surface medium phyto. Chl:C", "g Chl (g C)-1", missing_value = missing_value1)

    phyto(LARGE)%id_sfc_theta = register_diag_field(package_name, "sfc_theta_lgp", axes(1:2), &
         init_time, "Surface large phyto. Chl:C", "g Chl (g C)-1", missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_theta = register_diag_field(package_name, "sfc_theta_di", axes(1:2), &
         init_time, "Surface diazotroph Chl:C", "g Chl (g C)-1", missing_value = missing_value1)

    phyto(SMALL)%id_sfc_pcmlim_aclm = register_diag_field(package_name, "sfc_pcmlim_aclm_smp", &
         axes(1:2), &
         init_time, "Surface small phyto. Temp*Nut Lim", "none", missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_pcmlim_aclm = register_diag_field(package_name, "sfc_pcmlim_aclm_mdp", &
         axes(1:2), &
         init_time, "Surface medium phyto. Temp*Nut Lim", "none", missing_value = missing_value1)

    phyto(LARGE)%id_sfc_pcmlim_aclm = register_diag_field(package_name, "sfc_pcmlim_aclm_lgp", &
         axes(1:2), &
         init_time, "Surface large phyto. Temp*Nut Lim", "none", missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_pcmlim_aclm = register_diag_field(package_name, "sfc_pcmlim_aclm_di", &
         axes(1:2), &
         init_time, "Surface diazotroph Temp*Nut Lim", "none", missing_value = missing_value1)

    phyto(SMALL)%id_sfc_mu = register_diag_field(package_name, "sfc_mu_smp", axes(1:2), &
         init_time, "Surface small phyto. Chl:C", "sec-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_mu = register_diag_field(package_name, "sfc_mu_mdp", axes(1:2), &
         init_time, "Surface medium phyto. Chl:C", "sec-1", missing_value = missing_value1)

    phyto(LARGE)%id_sfc_mu = register_diag_field(package_name, "sfc_mu_lgp", axes(1:2), &
         init_time, "Surface large phyto. Chl:C", "sec-1", missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_mu = register_diag_field(package_name, "sfc_mu_di", axes(1:2), &
         init_time, "Surface diazotroph growth rate", "sec-1", missing_value = missing_value1)

    phyto(SMALL)%id_sfc_no3lim = register_diag_field(package_name, "sfc_no3lim_smp", axes(1:2), &
         init_time, "Surface small phyto. nitrate limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_no3lim = register_diag_field(package_name, "sfc_no3lim_mdp", axes(1:2), &
         init_time, "Surface medium phyto. nitrate limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_sfc_no3lim = register_diag_field(package_name, "sfc_no3lim_lgp", axes(1:2), &
         init_time, "Surface large phyto. nitrate limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_no3lim = register_diag_field(package_name, "sfc_no3lim_di", axes(1:2), &
         init_time, "Surface diazotroph nitrate limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_sfc_nh4lim = register_diag_field(package_name, "sfc_nh4lim_smp", axes(1:2), &
         init_time, "Surface small phyto. ammonia limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_nh4lim = register_diag_field(package_name, "sfc_nh4lim_mdp", axes(1:2), &
         init_time, "Surface medium phyto. ammonia limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_sfc_nh4lim = register_diag_field(package_name, "sfc_nh4lim_lgp", axes(1:2), &
         init_time, "Surface large phyto. ammonia limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_nh4lim = register_diag_field(package_name, "sfc_nh4lim_di", axes(1:2), &
         init_time, "Surface diazotroph ammonia limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(SMALL)%id_sfc_po4lim = register_diag_field(package_name, "sfc_po4lim_smp", axes(1:2), &
         init_time, "Surface small phyto. phosphate limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_sfc_po4lim = register_diag_field(package_name, "sfc_po4lim_mdp", axes(1:2), &
         init_time, "Surface medium phyto. phosphate limitation", "dimensionsless", &
         missing_value = missing_value1)

    phyto(LARGE)%id_sfc_po4lim = register_diag_field(package_name, "sfc_po4lim_lgp", axes(1:2), &
         init_time, "Surface large phyto. phosphate limitation", "dimensionless", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_sfc_po4lim = register_diag_field(package_name, "sfc_po4lim_di", axes(1:2), &
...
! CAS: Added diagnostic for diatom NPP in top 100m for CMIP
    ...
    phyto(DIAZO)%id_jprod_n_100 = register_diag_field(package_name, "jprod_ndi_100", axes(1:2), &
         init_time, "Diazotroph nitrogen prim. prod. integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jprod_n_100 = register_diag_field(package_name, "jprod_nsmp_100", axes(1:2), &
         init_time, "Small phyto. nitrogen  prim. prod. integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jprod_n_100 = register_diag_field(package_name, "jprod_nmdp_100", axes(1:2), &
         init_time, "Medium phyto. nitrogen  prim. prod. integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jprod_n_100 = register_diag_field(package_name, "jprod_nlgp_100", axes(1:2), &
         init_time, "Large phyto. nitrogen  prim. prod. integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jprod_n_new_100 = register_diag_field(package_name, "jprod_ndi_new_100", &
         axes(1:2), &
         init_time, "Diazotroph new (NO3-based) prim. prod. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_jprod_n_new_100 = register_diag_field(package_name, "jprod_nsmp_new_100", &
         axes(1:2), &
         init_time, "Small phyto. new (NO3-based) prim. prod. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_jprod_n_new_100 = register_diag_field(package_name, "jprod_nmdp_new_100", &
         axes(1:2), &
         init_time, "Medium phyto. new (NO3-based) prim. prod. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_jprod_n_new_100 = register_diag_field(package_name, "jprod_nlgp_new_100", &
         axes(1:2), &
         init_time, "Large phyto. new (NO3-based) prim. prod. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_jprod_n_n2_100 = register_diag_field(package_name, "jprod_ndi_n2_100", &
         axes(1:2), &
         init_time, "Diazotroph nitrogen fixation in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jzloss_n_100 = register_diag_field(package_name, "jzloss_ndi_100", axes(1:2), &
         init_time, "Diazotroph nitrogen loss to zooplankton integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_jzloss_n_100 = register_diag_field(package_name, "jzloss_nsmp_100", axes(1:2), &
         init_time, "Small phyto. nitrogen loss to zooplankton integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_jzloss_n_100 = register_diag_field(package_name, "jzloss_nmdp_100", &
         axes(1:2), &
         init_time, "Medium phyto. nitrogen loss to zooplankton integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_jzloss_n_100 = register_diag_field(package_name, "jzloss_nlgp_100", axes(1:2), &
         init_time, "Large phyto. nitrogen loss to zooplankton integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_jaggloss_n_100 = register_diag_field(package_name, "jaggloss_ndi_100", &
         axes(1:2), &
         init_time, "Diazotroph phyto. nitrogen aggregation loss integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(SMALL)%id_jaggloss_n_100 = register_diag_field(package_name, "jaggloss_nsmp_100", &
         axes(1:2), &
         init_time, "Small phyto. nitrogen aggregation loss integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(MEDIUM)%id_jaggloss_n_100 = register_diag_field(package_name, "jaggloss_nmdp_100", &
         axes(1:2), &
         init_time, "Medium phyto. nitrogen aggregation loss integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(LARGE)%id_jaggloss_n_100 = register_diag_field(package_name, "jaggloss_nlgp_100", &
         axes(1:2), &
         init_time, "Large phyto. nitrogen aggregation loss integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    phyto(DIAZO)%id_jvirloss_n_100 = register_diag_field(package_name, "jvirloss_ndi_100", &
         axes(1:2), &
         init_time, "Diazotroph nitrogen virus loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jvirloss_n_100 = register_diag_field(package_name, "jvirloss_nsmp_100", &
         axes(1:2), &
         init_time, "Small phyto. nitrogen virus loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jvirloss_n_100 = register_diag_field(package_name, "jvirloss_nmdp_100", &
         axes(1:2), &
         init_time, "Medium phyto. nitrogen virus loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jvirloss_n_100 = register_diag_field(package_name, "jvirloss_nlgp_100", &
         axes(1:2), &
         init_time, "Large phyto. nitrogen virus loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jmortloss_n_100 = register_diag_field(package_name, "jmortloss_ndi_100", &
         axes(1:2), &
         init_time, "Diazotroph nitrogen mortality loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jmortloss_n_100 = register_diag_field(package_name, "jmortloss_nsmp_100", &
         axes(1:2), &
         init_time, "Small phyto. nitrogen mortality loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jmortloss_n_100 = register_diag_field(package_name, "jmortloss_nmdp_100", &
         axes(1:2), &
         init_time, "Medium phyto. nitrogen mortality loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jmortloss_n_100 = register_diag_field(package_name, "jmortloss_nlgp_100", &
         axes(1:2), &
         init_time, "Large phyto. nitrogen mortality loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_jexuloss_n_100 = register_diag_field(package_name, "jexuloss_ndi_100", &
         axes(1:2), &
         init_time, "Diazotroph nitrogen exudation loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(SMALL)%id_jexuloss_n_100 = register_diag_field(package_name, "jexuloss_nsmp_100", &
         axes(1:2), &
         init_time, "Small phyto. nitrogen exudation loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_jexuloss_n_100 = register_diag_field(package_name, "jexuloss_nmdp_100", &
         axes(1:2), &
         init_time, "Medium phyto. nitrogen exudation loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    phyto(LARGE)%id_jexuloss_n_100 = register_diag_field(package_name, "jexuloss_nlgp_100", &
         axes(1:2), &
         init_time, "Large phyto. nitrogen exudation loss integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jprod_n_100 = register_diag_field(package_name, "jprod_nsmz_100", axes(1:2), &
         init_time, "Small zooplankton nitrogen prod. integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jprod_n_100 = register_diag_field(package_name, "jprod_nmdz_100", axes(1:2), &
         init_time, "Medium zooplankton nitrogen prod. integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jprod_n_100 = register_diag_field(package_name, "jprod_nlgz_100", axes(1:2), &
         init_time, "Large zooplankton nitrogen prod. integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jingest_n_100 = register_diag_field(package_name, "jingest_n_nsmz_100", axes(1:2), &
         init_time, "Small zooplankton nitrogen ingestion integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    zoo(2)%id_jingest_n_100 = register_diag_field(package_name, "jingest_n_nmdz_100", axes(1:2), &
         init_time, "Medium zooplankton nitrogen ingestion integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    zoo(3)%id_jingest_n_100 = register_diag_field(package_name, "jingest_n_nlgz_100", axes(1:2), &
         init_time, "Large zooplankton nitrogen ingestion integral in upper 100m", "mol m-2 s-1", &
         missing_value = missing_value1)

    zoo(1)%id_jzloss_n_100 = register_diag_field(package_name, "jzloss_nsmz_100", axes(1:2), &
         init_time, "Small zooplankton nitrogen loss to zooplankton integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(2)%id_jzloss_n_100 = register_diag_field(package_name, "jzloss_nmdz_100", axes(1:2), &
         init_time, "Medium zooplankton nitrogen loss to zooplankton integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(2)%id_jhploss_n_100 = register_diag_field(package_name, "jhploss_nmdz_100", axes(1:2), &
         init_time, "Medium zooplankton nitrogen loss to higher preds. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(3)%id_jhploss_n_100 = register_diag_field(package_name, "jhploss_nlgz_100", axes(1:2), &
         init_time, "Large zooplankton nitrogen loss to higher preds. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(2)%id_jprod_ndet_100 = register_diag_field(package_name, "jprod_ndet_nmdz_100", axes(1:2), &
         init_time, "Medium zooplankton nitrogen detritus prod. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(3)%id_jprod_ndet_100 = register_diag_field(package_name, "jprod_ndet_nlgz_100", axes(1:2), &
         init_time, "Large zooplankton nitrogen detritus prod. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(1)%id_jprod_don_100 = register_diag_field(package_name, "jprod_don_nsmz_100", axes(1:2), &
         init_time, "Small zooplankton dissolved org. nitrogen prod. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(2)%id_jprod_don_100 = register_diag_field(package_name, "jprod_don_nmdz_100", axes(1:2), &
         init_time, "Medium zooplankton dissolved org. nitrogen prod. integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(1)%id_jremin_n_100 = register_diag_field(package_name, "jremin_n_nsmz_100", axes(1:2), &
         init_time, "Small zooplankton nitrogen remineralization integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(2)%id_jremin_n_100 = register_diag_field(package_name, "jremin_n_nmdz_100", axes(1:2), &
         init_time, "Medium zooplankton nitrogen remineralization integral in upper 100m", &
         "mol m-2 s-1", missing_value = missing_value1)

    zoo(3)%id_jremin_n_100 = register_diag_field(package_name, "jremin_n_nlgz_100", axes(1:2), &
    ...
    phyto(SMALL)%id_f_n_100 = register_diag_field(package_name, "nsmp_100", axes(1:2), &
         init_time, "Small phytoplankton nitrogen biomass in upper 100m", "mol m-2", &
         missing_value = missing_value1)

    phyto(MEDIUM)%id_f_n_100 = register_diag_field(package_name, "nmdp_100", axes(1:2), &
         init_time, "Medium phytoplankton nitrogen biomass in upper 100m", "mol m-2", &
         missing_value = missing_value1)

    phyto(LARGE)%id_f_n_100 = register_diag_field(package_name, "nlgp_100", axes(1:2), &
         init_time, "Large phytoplankton nitrogen biomass in upper 100m", "mol m-2", &
         missing_value = missing_value1)

    phyto(DIAZO)%id_f_n_100 = register_diag_field(package_name, "ndi_100", axes(1:2), &
         init_time, "Diazotroph nitrogen biomass in upper 100m", "mol m-2", &
         missing_value = missing_value1)

    zoo(1)%id_f_n_100 = register_diag_field(package_name, "nsmz_100", axes(1:2), &
         init_time, "Small zooplankton nitrogen biomass in upper 100m", "mol m-2", &
         missing_value = missing_value1)

    zoo(2)%id_f_n_100 = register_diag_field(package_name, "nmdz_100", axes(1:2), &
         init_time, "Medium zooplankton nitrogen biomass in upper 100m", "mol m-2", &
         missing_value = missing_value1)

    zoo(3)%id_f_n_100 = register_diag_field(package_name, "nlgz_100", axes(1:2), &
